...
<body>
  ...
  <strong>{{ $success }}</strong> You are now registered successfully...!.
            ...
            <div class="col-md-8 card my-5 mx-auto p-5">
                ...
                <form action="/signup" method="post" class="form-group" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="username" placeholder="Username" class="form-control my-2" value="{{old('username')}}">
